...
Fecha de revisión local: 7-8 de septiembre de 2026. Fuente: `P100_TRANSFER/00_ORIGINALES/PDFM1000v2.pdf`. Se leyó la extracción completa de las 35 páginas y se inspeccionaron visualmente las páginas 9, 11, 28 y 31 para comprobar código y fórmula. Texto íntegro por página preservado en `06_VERIFICACION/pdf_checks/PDFM1000v2_pages.json` (83.909 caracteres según pypdf). El archivo original no se modificó.
